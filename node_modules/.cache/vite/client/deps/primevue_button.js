import {
  Base,
  script
} from "./chunk-SJFGBN5G.js";
import {
  PrimeVueService
} from "./chunk-DEJVEBAA.js";
import {
  BaseStyle,
  C,
  C2,
  ...
  s2,
  v
} from "./chunk-QURYNDDM.js";
import "./chunk-AMQSNGJJ.js";
...
import { createElementBlock as createElementBlock2, openBlock as openBlock2, mergeProps as mergeProps2, renderSlot, createTextVNode, toDisplayString } from "vue";
var script$1 = {
  name: "BaseBadge",
  "extends": script,
  props: {
...
function render2(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock2(), createElementBlock2("span", mergeProps2({
    "class": _ctx.cx("root"),
...
import { mergeProps as mergeProps3 } from "vue";
function _typeof3(o) {
  "@babel/helpers - typeof";
...
var BaseDirective = {
  ...
  _getPTDatasets: function _getPTDatasets() {
    ...
    return _objectSpread2(_objectSpread2({}, key === "root" && _defineProperty3({}, "".concat(datasetPrefix, "name"), g(instance.$name))), {}, _defineProperty3({}, "".concat(datasetPrefix, "section"), g(key)));
  },
  ...
  _mergeProps: function _mergeProps() {
    ...
    return c(fn) ? fn.apply(void 0, args) : mergeProps3.apply(void 0, args);
  },
...
import { mergeProps as mergeProps4, resolveComponent, resolveDirective, withDirectives, renderSlot as renderSlot2, createBlock, openBlock as openBlock3, resolveDynamicComponent, withCtx, createElementBlock as createElementBlock3, createCommentVNode, toDisplayString as toDisplayString2, normalizeClass } from "vue";
...
var script5 = {
  ...
  computed: {
    ...
    attrs: function attrs() {
      return mergeProps4(this.asAttrs, this.a11yAttrs, this.getPTOptions("root"));
    },
    ...
    dataP: function dataP2() {
      return f(_defineProperty6(_defineProperty6(_defineProperty6(_defineProperty6(_defineProperty6(_defineProperty6(_defineProperty6(_defineProperty6(_defineProperty6(_defineProperty6({}, this.size, this.size), "icon-only", this.hasIcon && !this.label && !this.badge), "loading", this.loading), "fluid", this.hasFluid), "rounded", this.rounded), "raised", this.raised), "outlined", this.outlined || this.variant === "outlined"), "text", this.text || this.variant === "text"), "link", this.link || this.variant === "link"), "vertical", (this.iconPos === "top" || this.iconPos === "bottom") && this.label));
    },
    dataIconP: function dataIconP() {
      return f(_defineProperty6(_defineProperty6({}, this.iconPos, this.iconPos), this.size, this.size));
    },
    dataLabelP: function dataLabelP() {
      return f(_defineProperty6(_defineProperty6({}, this.size, this.size), "icon-only", this.hasIcon && !this.label && !this.badge));
    }
  },
  components: {
    SpinnerIcon: script3,
...
function render3(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return !_ctx.asChild ? withDirectives((openBlock3(), createBlock(resolveDynamicComponent(_ctx.as), mergeProps4({
    key: 0,
    "class": _ctx.cx("root"),
    "data-p": $options.dataP
  }, $options.attrs), {
    "default": withCtx(function() {
      return [renderSlot2(_ctx.$slots, "default", {}, function() {
        return [_ctx.loading ? renderSlot2(_ctx.$slots, "loadingicon", mergeProps4({
          key: 0,
          "class": [_ctx.cx("loadingIcon"), _ctx.cx("icon")]
        }, _ctx.ptm("loadingIcon")), function() {
          return [_ctx.loadingIcon ? (openBlock3(), createElementBlock3("span", mergeProps4({
            key: 0,
            "class": [_ctx.cx("loadingIcon"), _ctx.cx("icon"), _ctx.loadingIcon]
          }, _ctx.ptm("loadingIcon")), null, 16)) : (openBlock3(), createBlock(_component_SpinnerIcon, mergeProps4({
            key: 1,
            "class": [_ctx.cx("loadingIcon"), _ctx.cx("icon")],
            spin: ""
          }, _ctx.ptm("loadingIcon")), null, 16, ["class"]))];
        }) : renderSlot2(_ctx.$slots, "icon", mergeProps4({
          key: 1,
          "class": [_ctx.cx("icon")]
        }, _ctx.ptm("icon")), function() {
          return [_ctx.icon ? (openBlock3(), createElementBlock3("span", mergeProps4({
            key: 0,
            "class": [_ctx.cx("icon"), _ctx.icon, _ctx.iconClass],
            "data-p": $options.dataIconP
          }, _ctx.ptm("icon")), null, 16, _hoisted_12)) : createCommentVNode("", true)];
        }), _ctx.label ? (openBlock3(), createElementBlock3("span", mergeProps4({
          key: 2,
          "class": _ctx.cx("label")
        }, _ctx.ptm("label"), {
          "data-p": $options.dataLabelP
        }), toDisplayString2(_ctx.label), 17, _hoisted_2)) : createCommentVNode("", true), _ctx.badge ? (openBlock3(), createBlock(_component_Badge, {
          key: 3,
          value: _ctx.badge,
    ...
    _: 3
  }, 16, ["class", "data-p"])), [[_directive_ripple]]) : renderSlot2(_ctx.$slots, "default", {
    key: 1,
